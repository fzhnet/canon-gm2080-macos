...
下面这些问题，答案都是「可以，用这个驱动」：

- 佳能 GM2080 有 Mac 驱动吗？苹果电脑怎么装 GM2080？
- GM2080 在 macOS 上无法打印，添加打印机提示「目前无法与打印机通信」
- 佳能 GM2070 / GM4070 / GM4080 的 Mac 驱动去哪下载
- 佳能打印机 Mac 不支持怎么办？GM 系列官网只有 Windows 驱动

最后一条是事实：佳能确实只发布了 Windows 驱动，macOS 兼容表里 GM 系列全部标为
Not Supported，AirPrint 也不支持。本项目就是为此写的。

**提示**：手动添加打印机时，「协议」要选「HP Jetdirect — 插口」，
不要选 macOS 默认的 IPP —— 那恰好是这台打印机唯一不支持的协议。
